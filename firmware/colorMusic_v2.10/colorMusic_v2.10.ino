  ...
  if (ONstate) {
    if (millis() - main_timer > MAIN_LOOP) {
      ...
      if (this_mode == 0 || this_mode == 1) {
        ...
        Serial.prinltln("RsoundLevel");
        Serial.prinltln(RsoundLevel);
        Serial.prinltln("LsoundLevel");
        Serial.prinltln(LsoundLevel);

        Serial.prinltln("RcurrentLevel");
        Serial.prinltln(RcurrentLevel);
        Serial.prinltln("LcurrentLevel");
        Serial.prinltln(RcurrentLevel);

        Serial.prinltln("RsoundLevel_f");
        Serial.prinltln(RsoundLevel_f);
        Serial.prinltln("LsoundLevel_f");
        Serial.prinltln(LsoundLevel_f);
        Serial.prinltln("averageLevel");
        Serial.prinltln(averageLevel);
